...
@if(backpack_user()->hasPermissionTo('access_report'))
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('attendance') }}"><i class="nav-icon la la-calendar"></i> Attendances</a></li>
@endif
